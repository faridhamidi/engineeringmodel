...
REQUIRED_NORMS: Mapping[str, str] = {
    ...
    "skill_invocation": "use only the depth the work earns",
    "skill_install_fallback": "install the packaged skill before continuing",
    "objective_skill_trigger": "not by a subjective sense of how large or important",
    "quality_heading": "## Implementation Quality",
    "safety_precedence": "Safety and data integrity override existing conventions",
    "existing_patterns": "Reuse the repository's existing patterns for the same concern",
    "self_audit": "self-audit changed code",
    "same_pass_fix": "fix findings in the same pass",
