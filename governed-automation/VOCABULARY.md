...
| **Control evaluation** | Runtime determination of whether already-selected controls pass for the current identity, evidence, policy, and operating conditions. | [Declared protected actions and derived controls](MODELS.md#11-declared-protected-actions-and-derived-controls) |
...
| **Control selection** | Static choice of which control categories a protected action requires, derived from declared action semantics rather than mutable runtime facts. | [Declared protected actions and derived controls](MODELS.md#11-declared-protected-actions-and-derived-controls) |
...
| **Protected action** | An action whose authorization or execution can create, change, disable, delete, admit, expose, or grant access to consequential shared or external state. | [Declared protected actions and derived controls](MODELS.md#11-declared-protected-actions-and-derived-controls) |
